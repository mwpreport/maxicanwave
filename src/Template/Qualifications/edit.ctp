						...
						<div class="event-button-cont">
							<ul class="side-nav">
								<li><?= $this->Form->postLink(
										__('<i class="fa fa-trash" aria-hidden="true"></i> Delete Qualification'),
										['action' => 'delete', $qualification->id],
										['escape' => false, 'confirm' => __('Are you sure you want to delete "{0}"?', $qualification->name)]
									)
								?></li>
								<li><?= $this->Html->link(__('<i class="fa fa-list" aria-hidden="true"></i> List Qualifications'), ['action' => 'index'], ['escape' => false]) ?></li>
							</ul>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-12">
							<div class="hr-title">
								<h2><?= __('Edit Qualification') ?></h2>
								<hr>
							</div>
						</div>
						<div class="clearfix"></div>
