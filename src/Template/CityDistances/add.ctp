					...
					<div class="row">
						...
						<div class="col-md-12">
								<div class="box-body no-padding">
									...
									<fieldset>
										<?php
                    echo '<div class="form-group mar-bottom-10"><div class="col-sm-4">'.$this->Form->control('city_from', ['class' => 'form-control', 'options' => $cities,'empty' => 'Select']).'</div>';
                    echo '<div class="col-sm-4">'.$this->Form->control('city_to', ['class' => 'form-control',  'options' => $cities,'empty' => 'Select']).'</div>';
