            ...
            <header class="main-header">
                ...
                <a href="index.php" class="logo">
                    ...
                    <span class="logo-mini">
                        <img src="<?php echo $this->Url->image('icon.png')?>" alt="logo-icon" height="30"/>
                    </span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><img src="<?php echo $this->Url->image('nwp.png')?>" alt="logo-icon" height="30"/></span>
                </a>
                                        ...
                                        <ul class="menu">
                                            <li><!-- start message -->
                                                <a href="#">
                                                    <div class="pull-left">
                                                        <!-- User Image -->
                                                        <img src="<?php echo $this->Url->image('avathar-blue.jpg')?>" class="img-circle" alt="User Image">
                                                    </div>
