       ...
       <?php if(!isset($month_days)){ ?>
        ...
        <section>
            <div class="white-wrapper">
                <div class="col-md-12">
                    <div class="hr-title">
                        <h2><?= __('Expenses') ?> <span class="go-back pull-right"><a href="<?php echo $this->Url->build(["controller" => "Mrs","action" => "expenses"])?>"><i class="fa fa-arrow-left"></i> Go Back</a></span></h2>
                        <hr>
                    </div>
                </div>
                <div class="clearfix"></div>
                            ...
                            <?php if (date('m', $time)==$month){
                               ...
                               if($k == 0){ ?>
                                    <tr style="<?php echo $bgcolor; ?>">
                                        ...
                                        <td colspan="12" style="color:red">Holiday / On Leave</td>
                                    </tr>
                              <?php }
                          }
                    } ?>
