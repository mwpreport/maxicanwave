...
<div class="ajax-wrapper">
    ...
    <div class="content">
        <section>
			...
			{
				$html.='<h3 class="mar-top-10 mar-bottom-10">Non-Listed Doctors</h3><table id="doctors_table" class="table table-striped table-bordered table-hover"><thead><tr><th width="">S.No</th><th>Doctor Name</th><th>Spec</th><th>City</th><th>Work With</th><th>Products</th><th>Samples</th><th>Gifts</th><th>Visit Time</th><th>Business</th></tr></thead><tbody>';
				$i = 1;
			...
			if(count($WorkPlansL))
			{
				...
				{
					$html.='<tr><td>'.$i.'</td><td>'.$WorkPlanL->leave_type->name.'</td></tr>';
				$i++;
				}
				$html.='</tbody></table>';
			}
			...
			if(count($WorkPlansC))
			{
				$html.='<h3 class="mar-top-10 mar-bottom-10">Chemists</h3><table id="plans_table" class="table table-striped table-bordered table-hover"><thead><tr><th width="">S.No</th><th>Chemists Name</th><th>City</th></tr></thead><tbody>';
				$i = 1;
			...
			if(count($WorkPlansS))
			{
				$html.='<h3 class="mar-top-10 mar-bottom-10">Stockists</h3><table id="plans_table" class="table table-striped table-bordered table-hover"><thead><tr><th width="">S.No</th><th>Stockists Name</th><th>City</th></tr></thead><tbody>';
				$i = 1;
			...
			if(count($WorkPlans))
			{
				...
				{
					$html.='<tr><td>'.$i.'</td><td>'.$WorkPlan->work_type->name.'</td></tr>';
				$i++;
				}
				$html.='</tbody></table>';
			}
