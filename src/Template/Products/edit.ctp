					...
					<div class="row">
						<div class="event-button-cont">
							<ul class="side-nav">
								<li><?= $this->Form->postLink(
										__('<i class="fa fa-trash" aria-hidden="true"></i> Delete Product'),
										['action' => 'delete', $product->id],
										['escape' => false, 'confirm' => __('Are you sure you want to delete "{0}"?', $product->name)]
									)
								?></li>
						...
						<div class="col-md-12">
								<div class="box-body no-padding">
									<?= $this->Form->create($product, array('id' => 'editform')) ?>
									<fieldset>
