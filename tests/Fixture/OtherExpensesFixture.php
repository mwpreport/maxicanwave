...
/**
 * OtherExpensesFixture
 *
 */
class OtherExpensesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'other_expenses_ibfk_1' => ['type' => 'foreign', 'columns' => ['expense_id'], 'references' => ['expenses', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
