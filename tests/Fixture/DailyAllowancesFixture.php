...
/**
 * DailyAllowancesFixture
 *
 */
class DailyAllowancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'daily_allowances_ibfk_1' => ['type' => 'foreign', 'columns' => ['expense_type_id'], 'references' => ['expense_types', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'daily_allowances_ibfk_2' => ['type' => 'foreign', 'columns' => ['role_id'], 'references' => ['roles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
